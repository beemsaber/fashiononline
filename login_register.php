        ...
        <div class="shopping-cart"> 
          ...
          <div class="cart-ship-info">
            <div class="row">
              ...
              <div class="col-sm-6">
                <h6>สมัครสมาชิก</h6>
                <form name="form_user_regis" id="form_user_regis" method="post">
                  <ul class="row">
                    
                    <!-- Name -->
                    <li class="col-md-6">
                      <label> *ชื่อ - นามสกุล
                        <input type="text" id="user_name" name="user_name" value="" placeholder="">
                      </label>
                    </li>
                    <!-- EMAIL ADDRESS -->
                    <li class="col-md-6">
                      <label>  อีเมล
                        <input type="text" id="user_email" name="user_email" value="" placeholder="">
                      </label>
                    </li>
                    ...
                    <li class="col-md-12"> 
                      <!-- ADDRESS -->
                      <label> ที่อยู่
                        <textarea class="form-control" id="user_address" name="user_address" rows="5" placeholder=""></textarea>
                      </label>
                    </li>
                    ...
                    <li class="col-md-6">
                      <label> จังหวัด
                        <select class="form-control" name="user_province" id="user_province">
                    ...
                    <li class="col-md-6">
                      <label> รหัสไปรษณีย์
                        <input type="text" id="user_zipcode" name="user_zipcode" value="" placeholder="">
                      </label>
                    </li>
                    ...
                    <li class="col-md-6">                      
                      <label> เบอร์โทรศัพท์
                        <input type="text" id="user_tel" name="user_tel" value="" placeholder="">
                      </label>
                    </li>
                    ...
                    <li class="col-md-6">
                      <label> ชื่อเข้าใช้งาน
                        <input type="text"id="user_username" name="user_username" value="" placeholder="">
                      </label>
                    </li>
                    ...
                    <li class="col-md-6">
                      <label> รหัสผ่าน
                        <input type="password" id="user_password" name="user_password" value="" placeholder="">
                      </label>
                    </li>
                    ...
                    <li class="col-md-12">
                      ...
                      <button type="button" id="register" name="register" class="btn pull-left">สมัคร</button>
                    </li>
                  </ul>
                </form>
              </div>
