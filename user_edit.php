                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">                                
                                <div class="form-body">
                                    <h3 class="card-title"><a href="index.php" class="btn waves-effect waves-light btn-secondary"><i class="fa fa-lg mdi mdi-chevron-left"></i>กลับหน้าแรก</a></h3>
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="index.php" class="btn btn-inverse">ยกเลิก</a>
                                </div>
